...
rt_ha = rt/+dragonfly/+x86_64.ha rt/+dragonfly/env.ha rt/+dragonfly/errno.ha rt/+dragonfly/initfini.ha rt/+dragonfly/platform_abort.ha rt/+dragonfly/platformstart-libc.ha rt/+dragonfly/random.ha rt/+dragonfly/segmalloc.ha rt/+dragonfly/signal.ha rt/+dragonfly/socket.ha rt/+dragonfly/start.ha rt/+dragonfly/syscallno.ha rt/+dragonfly/syscalls.ha rt/+dragonfly/sysctl.ha rt/+dragonfly/types.ha rt/+x86_64/arch_jmp.ha rt/+x86_64/cpuid.ha rt/abort.ha rt/ensure.ha rt/fenv_defs.ha rt/heap-libc.ha rt/jmp.ha rt/malloc.ha rt/memcpy.ha rt/memfunc_ptr.ha rt/memmove.ha rt/memset.ha rt/strcmp.ha rt/u64tos.ha rt/unknown_errno.ha
$(HARECACHE)/rt.ssa: $(rt_ha)
	@mkdir -p -- "$(HARECACHE)"
	@printf 'HAREC\t%s\n' "$@"
	@$(TDENV) $(HAREC) $(HARECFLAGS) -o $@ -t $(HARECACHE)/rt.td.tmp -N rt $(rt_ha)

rt_s = $(HARECACHE)/rt.s rt/+dragonfly/start+x86_64-libc.s rt/+dragonfly/syscall+x86_64.s rt/+x86_64/cpuid.s rt/+x86_64/fenv.s rt/+x86_64/longjmp.s rt/+x86_64/setjmp.s
$(HARECACHE)/rt.o: $(rt_s)
	@printf 'AS\t%s\n' "$@"
	@$(AS) $(ASFLAGS) -o $@ $(rt_s)
...
io_ha = io/+dragonfly/dup.ha io/+dragonfly/mmap.ha io/+dragonfly/platform_file.ha io/+dragonfly/sync.ha io/+dragonfly/vector.ha io/arch+x86_64.ha io/copy.ha io/drain.ha io/empty.ha io/file.ha io/handle.ha io/limit.ha io/stream.ha io/tee.ha io/types.ha io/util.ha io/zero.ha
