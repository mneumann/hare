...
rt_ha = rt/+dragonfly/+x86_64.ha rt/+dragonfly/env.ha rt/+dragonfly/errno.ha rt/+dragonfly/initfini.ha rt/+dragonfly/platform_abort.ha rt/+dragonfly/platformstart-libc.ha rt/+dragonfly/segmalloc.ha rt/+dragonfly/signal.ha rt/+dragonfly/socket.ha rt/+dragonfly/start.ha rt/+dragonfly/syscallno.ha rt/+dragonfly/syscalls.ha rt/+dragonfly/sysctl.ha rt/+dragonfly/types.ha rt/+x86_64/arch_jmp.ha rt/+x86_64/cpuid.ha rt/abort.ha rt/ensure.ha rt/fenv_defs.ha rt/heap-libc.ha rt/jmp.ha rt/malloc.ha rt/memcpy.ha rt/memfunc_ptr.ha rt/memmove.ha rt/memset.ha rt/strcmp.ha rt/u64tos.ha rt/unknown_errno.ha
